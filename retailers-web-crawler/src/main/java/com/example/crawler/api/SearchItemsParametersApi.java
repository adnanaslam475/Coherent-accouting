...
public class SearchItemsParametersApi {
	...
	public String toString() {
		return "SearchItemsParametersApi [minItemsSold=" + minItemsSold + ", maxItemsSold=" + maxItemsSold
				+ ", retailerUserName=" + retailerUserName + ", saleDateRange=" + saleDateRange + ", pageNumber="
				+ pageNumber + "]";
	}
