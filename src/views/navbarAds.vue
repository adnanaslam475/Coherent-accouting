    ...
    <b-navbar toggleable="lg" type="light" variant="light" style="padding: 1.5rem;" class="dark-bg-color">
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        {{ $t("navbar.prices") }}
          ...
          <b-nav-item href="https://www.facebook.com/" target="_blank">
          ...
          <b-nav-item href="https://www.tiktok.com/" target="_blank">
          ...
          <b-nav-item href="https://www.instagram.com/" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="25" viewBox="0 0 48 48">
              <path fill="#304ffe"
