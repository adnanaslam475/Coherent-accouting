    ...
    <b-navbar toggleable="lg" type="light" variant="light" style="padding: 1.5rem;" class="dark-bg-color">
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        {{ $t("navbar.prices") }}
          ...
          <b-nav-item href="https://www.facebook.com/">
          ...
          <b-nav-item href="https://www.twitter.com/">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="25" viewBox="0 0 48 48">
              <path fill="#03A9F4"
          ...
          <b-nav-item href="https://www.linkedin.com/">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="25" viewBox="0 0 48 48">
              <path fill="#0288D1"
          ...
          <b-nav-item href="https://www.instagram.com/">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="25" viewBox="0 0 48 48">
              <path fill="#304ffe"
