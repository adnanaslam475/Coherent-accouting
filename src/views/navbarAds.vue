<template>
  <b-col lg="12" sm="12" md="12" class="p-0">
    <b-navbar toggleable="lg" type="light" variant="light" style="padding: 1.5rem;" class="dark-bg-color">
      <b-navbar-brand href="#">
        <div class="d-flex align-items-center">
          <b-link class="navbar-brand d-flex align-items-center" :to="{ name: 'why-choose-us' }">
