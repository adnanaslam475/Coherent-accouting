                ...
                <b-card style="max-width: 20rem;" class="mb-2">
                    <div class="custome-card">
                        ...
                        <div style="color: green;">
                            <feather-icon icon="CheckCircleIcon" stroke="green" /> CoherentAccounting
                        </div>
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
                                viewBox="0 0 64 64">
                                <path fill="#82d8bb" d="M32 4A28 28 0 1 0 32 60A28 28 0 1 0 32 4Z"></path>
                                <path fill="#72caaf" d="M32 9A23 23 0 1 0 32 55A23 23 0 1 0 32 9Z"></path>
                                <path fill="#fff"
                                ...
                                <path fill="none" stroke="#8d6c9f" stroke-linecap="round" stroke-linejoin="round"
...
<script>
import { BTabs, BTab, BCardText, BCol, BCard, BButton, BRow, BModal } from "bootstrap-vue"
        ...
        async connectToQuickBooks(type) {
            axios
                ...
                .then((response) => {
                    ...
                    window.open(response.data.redirectUrl, '_blank', 'width=600,height=400');
