            ...
            <div>
              ...
              <b-tabs content-class="mt-1" class="modal-tabs" align="center">
                <b-tab title="How to connect" active>
                  <ol>
                    <li class="my-1">
                      Click the <b>Connect software</b> button - you'll be
                      redirected from Coherent Accounting to
                      {{ type == "qbo" ? "QuickBook" : "Xero" }} Online and
                      promoted to log in.
                    </li>
                    <li class="my-1">
                      Select matching company in Coherent Accounting and
                      correponding in {{ type == "qbo" ? "QuickBook" : "Xero" }}
                    </li>
