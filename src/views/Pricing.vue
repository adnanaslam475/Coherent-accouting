<template>
  <section id="pricing-plan">
          ...
          >
            ...
            <b-col md="4">
              <b-card class="pb-1 popular" align="center">
                ...
                <b-card-text>{{
                  $t("pricing.small_to_medium_businesses")
                }}</b-card-text>
    ...
    <!--Footnote  -->
    <b-row>
      <b-col sm="10" md="12" offset-lg="2" lg="10" class="mx-auto"
        ><b>Note:</b> All prices are without VAT</b-col
      >
    </b-row>
  ...
  methods: {
    ...
    upGradePlan(plan) {
      const response = axios.post(
        "account/api/payment/create-payment",
        {
          compnayLimit: 0,
          documentLimit: 0,
          fee: 0,
