<template>
  <section id="pricing-plan">
    ...
    <!--Footnote  -->
    <b-row>
      <b-col sm="10" md="12" offset-lg="2" lg="10" class="mx-auto"><b>Note:</b> All prices are without VAT</b-col>
    </b-row>
        ...
        <b-col lg="10" offset-lg="3" class="mx-auto">
          <div class="pricing-trial-content d-flex justify-content-between">
            <div class="text-center text-md-left mt-3">
              ...
              <b-link to="/my-plans" v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary"
...
export default {
  ...
  methods: {
    ...
    upGradePlan(plan) {
      const response = axios.post("account/api/payment/create-payment", {
        "compnayLimit": 0,
        "documentLimit": 0,
        "fee": 0,
        "id": 0,
