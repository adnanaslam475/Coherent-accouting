  ...
  <div>
    ...
    <section id="about-content">
      ...
      <b-row class="kb-search-content-info match-height m-0">
        <b-col v-for="item in about" :key="item.title" md="4" sm="6" class="kb-search-content mb-3">
        ...
        <b-card-code class="d-flex flex-column justify-content-center align-items-center py-2 w-100">
          <div class="w-50 bg-white p-2 rounded">
            <b-embed type="iframe" aspect="16by9" src="https://www.youtube.com/embed/wfReNsbyhcU" allowfullscreen />
            <h4 class="text-primary mt-1">
              FREE OCR of invocies and receipts for XERO!!! Convert scanned invocies for import in QuickBooks - REMOVE
              MANUAL WORK
            </h4>
          </div>
        </b-card-code>
...
import {
  BRow, BCol, BCard, BCardBody, BForm, BEmbed, BInputGroup, BFormInput, BCardText, BInputGroupPrepend,
} from 'bootstrap-vue'
