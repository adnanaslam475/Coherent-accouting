  ...
  <div class="tabs tabs-hide-print">
    <b-nav tabs align="left" style="font-size: 0.8vw !important">
      <b-nav-item
        :to="{
          name: 'CompanyView',
          params: { InvoiceId: 0, id: $route.params.companyId },
        }"
        :active="invoiceTab !== 0"
      >
      ...
      <b-nav-item
        :to="{
          name: 'CompanyView',
          params: { InvoiceId: 1, id: $route.params.companyId },
        }"
        :active="invoiceTab !== 0"
      >
      ...
      <b-nav-item
        :to="{
          name: 'CompanyView',
          params: { InvoiceId: 2, id: $route.params.companyId },
        }"
        :active="invoiceTab !== 0"
      >
      ...
      <b-nav-item
        :to="{
          name: 'CompanyView',
          params: { InvoiceId: 3, id: $route.params.companyId },
        }"
        :active="invoiceTab !== 0"
      >
      ...
      <b-nav-item
        :to="{
          name: 'CompanyView',
          params: { InvoiceId: 5, id: $route.params.companyId },
        }"
        :active="invoiceTab !== 0"
      >
      ...
      <b-nav-item
        :to="{
          name: 'CompanyView',
          params: { InvoiceId: 6, id: $route.params.companyId },
        }"
        :active="invoiceTab !== 0"
      >
