  ...
  <div>
    <div class="row">
              ...
              >
                <div class="card" style="margin-right: 10px">
                  <div class="card-body" style="padding: 0px">
                    ...
                    <div
                      class="d-flex justify-space-between align-items-center mt-2"
                    >
                      <div
                    ...
                    <div
                      class="d-flex justify-space-between align-items-center ml-1"
                    >
                  ...
                  <b-col cols="12" style="padding-left: 0.7rem">
                    <table class="mt-2 mt-xl-0 w-100 company-info-table">
                      ...
                      <tr>
                        ...
                        <td
                          v-if="companyDetails.companyBankName != null"
                          class="pb-50"
                        >
                          <CopyToClipboard
                      ...
                      <tr>
                        ...
                        <td
                          v-if="companyDetails.companyBankBic != null"
                          class="pb-50"
                        >
                          <CopyToClipboard
      ...
      <div class="col-md-12 col-lg-4 col-xl-4 col-12">
        <b-card
          id="inner-card-body"
          class="border-primary ml-0 body-0 pr-3 h-100"
        >
          ...
          <div class="button-position-right">
            ...
            >
              ...
              <b-dropdown-item @click="actionTab">
                {{ $t("company_info.create_private_person") }}
              </b-dropdown-item>
              <b-dropdown-item>
      ...
      <b-col class="mb-1" cols="12">
        ...
        <b-card no-body style="padding: 0px" class="mb-2">
          <b-card-header style="padding: 1.5rem 1.5rem 1.52rem 1rem">
            <b-card-title>
              {{ $t("company_info.report_timeline") }}
            </b-card-title>
            <div
              ...
              <app-timeline>
                ...
                >
                  <div class="d-flex flex-sm-row flex-column mb-sm-0 mb-1">
                    ...
                    <h6>
                      {{ graph.count }}
                      {{ $t("company_info.reports_have_been_created") }}
                    </h6>
                  </div>
                </app-timeline-item>
              </app-timeline>
