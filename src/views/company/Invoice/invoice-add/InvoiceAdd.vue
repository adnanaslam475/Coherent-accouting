    ...
    ">INVOICE</b-button>
                        ...
                        <b-col class="px-0 text-end">
                          <div class="d-flex mr-0 flex-column float-right">
                            ...
                            <div class="pt-1">
                              <b-button class="p-0 m-0" variant="link" @click="showInvoiceInput = true"
                                v-if="!showInvoiceInput">{{ invoiceData.invoiceNumber }}</b-button>
                              <b-form-input v-if="showInvoiceInput" v-model="invoiceData.invoiceNumber" type="text"
                                class="mb-0" style="width: 130px" />
                            </div>
                          </div>
                        </b-col>
                      </b-row>
                                  ...
                                  <b-row class="flex-grow-1 py-1 invoice-add-transections"
                                    ...
                                    <b-col cols="12" lg="2" v-if="invoiceData.xero">
                                      ...
                                      <validation-provider #default="{ errors, invalid }" name="Category"
                                        ref="selectCategory" rules="required">
                                    ...
                                    <b-col cols="12" lg="2" v-if="invoiceData.xero">
                                      ...
                                      <validation-provider #default="{ errors, invalid }" name="Post Code"
                                        ...
                                        <b-form-select id="postCode" :options="jobPostItems"
                                    ...
                                    <b-col cols="12" lg="4">
                                      ...
                                      <validation-provider #default="{ errors, invalid }" name="Description"
                                        rules="required" ref="transectionServiceOrItemDescription">
                  ...
                  <b-card class="d-flex" style="text-align: end">
                    ...
                    <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="outline-primary" class="mr-2"
                      :disabled="loading" @click="invoiceAdd(invoiceData, 'save', AccountTypeOption)">
