                ...
                >
                  <b-tabs v-model="companyTab">
                    ...
                    <b-tab>
                      ...
                      <b-row
                        ...
                        style="height: 5px; border-top: 1px solid lightgrey"
                      >
                        <b-col
                          cols="12"
                          xl="12"
                              ...
                              <b-col cols="12" class="p-0">
                                ...
                                /> -->
                                  ...
                                  >
                                    <feather-icon
                                      v-if="
                                        invoiceData.transactions.length !== 1
                                      "
                                      size="14"
                                      icon="Trash2Icon"
                                      color="red"
                      ...
                      <b-card
                        no-body
                        class="invoice-add-card mb-1 mt-1"
                        v-if="isBank"
                      >
                        <b-card-body
                    ...
                    <b-tab>
                      ...
                      <div>
                        <div class="mb-1">
                          ...
                          <b-input-group
                            class="input-group invoice-edit-input-group pt-1 w-100"
                          >
                            <validation-provider
                              #default="{ errors }"
                  ...
                  <b-card class="d-flex" style="text-align: end">
                    ...
                    <b-button
                      ...
                      :disabled="loading"
                      @click="
                        invoiceAdd(invoiceData, 'preview', AccountTypeOption)
                      "
                    >
                    ...
                    <b-button
                      ...
                      :disabled="loading"
                      @click="
                        invoiceAdd(invoiceData, 'verify', AccountTypeOption)
                      "
                    >
                      <b-spinner v-if="loading" small variant="light" />
        ...
        <b-row class="invoice-add" v-else>
          ...
          <b-col cols="12" xl="10" md="10" v-if="isTemplateFive">
            ...
            <div>
              <!-- Account Type -->
              <div
                class="d-flex justify-content-between align-items-center mb-2 accountType"
              >
                ...
                <b-form-checkbox
                  ...
                  switch
                >
                  <span class="switch-icon-left" style="width: 76px">{{
                    $t("add_invoice.scheduled")
                  }}</span>
                  <span class="switch-icon-right" style="width: 76px">{{
                    ...
                    <div class="w-100 mt-md-0 mt-2">
                      <div class="d-flex align-items-center mb-0">
                        ...
                        <div class="d-block">
                          ...
                          <small
                            class="text-danger d-flex w-100 pl-1"
                            v-if="isWeekSelected"
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
              ...
              <b-card no-body class="invoice-preview date-issued mb-0">
                <b-card-header class="justify-content-end">
                  <div class="mt-md-0 mt-2">
                    <div
                      class="d-flex align-items-center mb-0 position-relative"
                    >
                      <span class="title mr-1">
                        {{ $t("add_invoice.date") }}:
                      </span>
            ...
            <b-row v-if="companyInBG">
              <b-col>
                ...
                <small class="text-danger" v-if="notBank"
                  >Please Select the payment type</small
                >
              </b-col>
            </b-row>
                  ...
                  <div class="tm_invoice_in">
                    ...
                    >
                      ...
                      <b-form-checkbox
                        v-model="InvoicePayedToggleValue"
                        @change="
                          InvoicePayedOptionToggle(InvoicePayedToggleValue)
                        "
                        class="custom-control-primary custom-switch-btn-2 flex-1 text-center"
                        name="AccountTypeOptionToggle"
                        switch
                    ...
                    >
                      <b-card
                        v-if="
                          invoiceData.cronScheduleApi.scheduleType == 'MONTHLY'
                        "
                        no-body
                        class="invoice-preview date-issued mb-0 ml-0 mr-auto"
                      >
                      ...
                      <b-card
                        v-if="
                          invoiceData.cronScheduleApi.scheduleType == 'WEEKLY'
                        "
                        no-body
                        class="invoice-preview date-issued mb-0 ml-0 mr-auto"
                      >
                      ...
                      <div class="tm_invoice_left" style="width: 44%">
                        ...
                        >
                          <b-form-input
                            ...
                            style="margin-bottom: 5px"
                            :placeholder="
                              $t('add_invoice.SupplierCompanyOwnerName')
                            "
                          />
                          <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                        ...
                        >
                          <b-form-input
                            ...
                            autocomplete="off"
                            :placeholder="
                              $t('add_invoice.SupplierCompanyAddress')
                            "
                            style="margin-bottom: 5px"
                          />
                          <small class="text-danger">{{ errors[0] }}</small>
                      ...
                      >
                        ...
                        >
                          <b-form-input
                            ...
                            style="margin-bottom: 5px"
                            :placeholder="
                              $t('add_invoice.RecipientCompanyIDNumber')
                            "
                          />
                          <b-list-group
                            v-if="showSuggestionsEicRecipient"
                          ...
                          <b-form-input
                            ...
                            style="margin-bottom: 5px"
                            :placeholder="
                              $t('add_invoice.RecipientPersonIDNumber')
                            "
                          />
                          <b-list-group
                        ...
                        >
                          <b-form-input
                            ...
                            style="margin-bottom: 5px"
                            :placeholder="
                              $t('add_invoice.RecipientCompanyOwnerName')
                            "
                          />
                        </validation-provider>
                        ...
                        >
                          <b-form-input
                            ...
                            style="margin-bottom: 5px"
                            :placeholder="
                              $t('add_invoice.RecipientCompanyName')
                            "
                          />
                          <b-list-group
                            v-if="showSuggestionsRecipient"
                        ...
                        >
                          <b-form-input
                            ...
                            style="margin-bottom: 5px"
                            :placeholder="
                              $t('add_invoice.RecipientCompanyAddress')
                            "
                          />
                          <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                          ...
                          >
                            ...
                            >
                              <b-form-input
                                ...
                                autocomplete="off"
                                :placeholder="
                                  $t('add_invoice.RecipientCompanyVATNumber')
                                "
                              />
                            </b-input-group>
                            <small class="text-danger">{{ errors[0] }}</small>
  ...
  computed: {
    ...
    banks() {
      return [
        ...
        {
          text: i18n.tc("paymentMethods.BANK_TRANSFER"),
          value: "BANK_TRANSFER",
        },
        { text: i18n.tc("paymentMethods.CARD"), value: "CARD" },
        {
          text: i18n.tc("paymentMethods.CASH_ON_DELIVERY"),
          value: "CASH_ON_DELIVERY",
        },
        {
          text: i18n.tc("paymentMethods.WITH_INTERCEPTION"),
          value: "WITH_INTERCEPTION",
        },
        { text: i18n.tc("paymentMethods.POST_ORDER"), value: "POST_ORDER" },
        { text: i18n.tc("paymentMethods.INTERNET"), value: "INTERNET" },
        {
          text: i18n.tc("paymentMethods.PAYMENT_ORDER"),
          value: "PAYMENT_ORDER",
        },
      ];
    },
          ...
          useJwt
            ...
            .then(async (response) => {
              ...
              this.$toast({
                ...
                props: {
                  title: this.$t(
                    "invoice_details.invoice_created_successfully"
                  ),
                  icon: "EditIcon",
                  variant: "success",
                },
  ...
  setup() {
    ...
    if (router.currentRoute.params.invoiceData) {
      ...
      invoiceData.value.tradeDiscountPercent = invoiceData?.value
        ...
        : 0;
      invoiceData.value.tradeDiscountAmount = invoiceData?.value
        ?.tradeDiscountAmount
      ...
      useJwt
        ...
        .then((response) => {
          ...
          invoiceData.value.supplierCompany.companyEic =
            Response?.companyIdentificationNumber;
          invoiceData.value.supplierCompany.companyVatEic =
            Response?.companyVatNumber;
          invoiceData.value.supplierCompany.companyAddress =
    ...
    var populateValues = () => {
      ...
      if (
        companyData.value.companyVatNumber == null ||
        companyData.value.companyVatNumber == ""
      ) {
    ...
    axios
      .get(
        "/account/api/invoice/get-next-number/" +
          `${router.currentRoute.params.companyId}`
      )
      .then((response) => {
