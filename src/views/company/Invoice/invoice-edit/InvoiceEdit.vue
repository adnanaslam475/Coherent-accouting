<template>
  <section class="invoice-add-wrapper">
    ...
    <validation-observer ref="invoiceEditForm" #default="{ invalid }">
      <b-form
        @submit.prevent="invoiceEdit(invoiceData, 'save', AccountTypeOption)"
      >
        <b-row v-if="invoiceData" class="invoice-add">
          ...
          <b-col cols="12" xl="10" md="10" v-if="isTemplateFive">
            ...
            <div>
              ...
              >
                <b-form-checkbox
                  ...
                  class="custom-control-primary custom-switch-btn fmr-2"
                ...
                <b-card
                  no-body
                  class="invoice-preview date-issued mb-0 ml-auto"
                >
                  <b-card-header class="justify-content-end">
                    <div class="mt-md-0 mt-2">
                      <div class="d-flex align-items-center mb-0">
              ...
              >
                <!-- Schedule Type -->
                <div
                  class="d-flex justify-content-between align-items-center schedule-type"
                  v-if="invoiceData.cronScheduleApi"
                >
                  <b-card
                    v-if="
                      invoiceData.cronScheduleApi.scheduleType == 'MONTHLY' &&
                      invoiceData.scheduled
                    "
                    no-body
                    ...
                    <b-card-header class="justify-content-start">
                      <div class="w-100 mt-md-0 mt-2">
                        <div class="d-flex align-items-center mb-0">
                          ...
                          <small class="text-danger" v-if="isWeekSelected"
                            >Day of Week field is required</small
                          >
                          <!-- </validation-provider> -->
                        </div>
                      </div>
                    ...
                    <b-card-header class="justify-content-end">
                      <div class="mt-md-0 mt-2">
                        <div class="d-flex align-items-center mb-0">
                          ...
                          >
                            <b-form-select
                              v-model="offCaseScheduleDayOfMonth"
                              @change="
                                () => {
                                  companyIDisInvalid = false;
                                }
                ...
                >
                  <b-card
                    v-if="!checkSchedule && isScheduled"
                    no-body
                    class="invoice-preview date-issued mb-0 ml-0 mr-auto"
                  >
                    <b-card-header class="justify-content-start">
                      <div class="w-100 mt-md-0 mt-2">
                        <div class="d-flex align-items-center mb-0">
                          ...
                          >
                            <b-form-radio-group
                              v-model="offCaseScheduleDayOfWeek"
                              class="d-flex"
                              :aria-describedby="ariaDescribedby"
                            >
                              <b-form-radio
                      ...
                      <div class="d-flex align-items-center mb-1">
                        ...
                        >
                          ...
                          >
                            ...
                            <small class="text-danger">{{ errors[0] }}</small>
                            <small class="text-danger" v-if="companyIDisInvalid"
                              >Company ID is not correct</small
                            >
                          </validation-provider>
                        </b-input-group>
                      </div>
            ...
            <b-card no-body class="invoice-add-card mb-1">
              <b-card-body class="invoice-padding form-item-section p-0">
                <b-row
                  class="pb-0 m-0 border transaction-container border-1 border-primary"
                >
                  <!-- Col: Sales Persion -->
                    ...
                    <b-col>
                      ...
                      >
                        ...
                        >
                          ...
                          <template
                            #selected-option="option"
                            v-else-if="editMode && bankNameToSend === ''"
                          >
                            <div
                              style="
                                display: flex;
            ...
            <b-row
              v-if="
                invoiceData.vatPercent === '0' || invoiceData.vatPercent === 0
              "
              class="mt-2"
            >
              <b-col>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <template
                            #selected-option="option"
                            v-if="editClauseMode && clauseToSend !== ''"
                          >
                            <div
                              style="
                                display: flex;
                          ...
                          <template
                            #selected-option="option"
                            v-else-if="editClauseMode && clauseToSend === ''"
                          >
                            <div
                              style="
                                display: flex;
                          ...
                          >
                            ...
                            >
                              <b-form-input
                                ...
                                "
                                autocomplete="off"
                                placeholder="Supplier Company Vat Number..."
                                style="margin-bottom: 5px"
                              />
                            </b-input-group>
                            <small class="text-danger">{{ errors[0] }}</small>
                      ...
                      <div class="tm_left_footer">
                        ...
                        <b-row class="mt-2">
                          <b-col
                            cols="12"
                            md="7"
                            class="mt-md-6 d-flex ml-5 pl-4 pt-2"
                            order="2"
                            order-md="1"
                          >
                            <h1 class="invoiceTypeHeading">
                      ...
                      <div class="tm_left_footer">
                        ...
                        <b-row class="mt-2">
                          <b-col
                            cols="12"
                            md="7"
                            class="mt-md-6 d-flex ml-5 pl-3 pt-2"
                            order="2"
                            order-md="1"
                          >
                            <h1 class="invoiceTypeHeading">
                        ...
                        >
                          ...
                          <span>
                            ...
                            <feather-icon
                              ...
                              size="16"
                              icon="CalendarIcon"
                              class="cursor-pointer clear-all mr-2 mt-1"
                              style="color: black"
                            />
                            <feather-icon
                              v-else
                  ...
                  >
                    <tr>
                      <td style="text-align: center; padding: 30px">
                        ...
                        <div
                          style="height: 50px; border-bottom: 1px dashed black"
                        >
                          <!-- Space for supplier's signature -->
                        </div>
                        <div style="margin-top: 10px">
          ...
          <b-col cols="12" md="2" xl="2" class="invoice-actions">
            ...
            <div class="row mb-2">
              <div
                class="ml-1 cursor-pointer color-button"
                style="background-color: #ad3978"
                @click="applyCover(1)"
              ></div>
              <div
                class="cursor-pointer color-button"
                style="background-color: #007aff"
                @click="applyCover(2)"
              ></div>
              <div
                class="cursor-pointer color-button"
                style="background-color: #8fce00"
                @click="applyCover(3)"
              ></div>
              <div
                class="cursor-pointer color-button"
