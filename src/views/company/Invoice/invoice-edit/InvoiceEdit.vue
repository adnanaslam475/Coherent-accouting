              ...
              >
                <b-tabs v-model="companyTab">
                  ...
                  <b-tab>
                    ...
                    <div v-if="companyInBG">
                        ...
                        >
                          ...
                          >
                            <b-button
                              ...
                              "
                              >{{ $t("company_invoices.INCOME") }}</b-button
                            >
                            <b-button
                              variant=""
                              :style="
                              ...
                              "
                              >{{ $t("company_invoices.EXPENSE") }}</b-button
                            >
                          </b-button-group>
                        </b-col>
                      </b-row>
                      ...
                      >
                        ...
                        >
                          <div
                            class="d-flex flex-row align-items-baseline mr-0 text-end"
                            ...
                            <p class="invoice-total-amount">
                              ...
                              >
                                <b-form-input
                                  ...
                                  class="text-right"
                                />
                                <small class="text-danger" v-if="inValidTax">{{
                                ...
                                <div class="d-none d-lg-flex p-custom">
                                  ...
                                  >
                                    ...
                                    >
                                      {{
                                        $t(
                                          "add_invoice.service_item_description"
                                        )
                                      }}
                                    </b-col>
                                    <b-col
                                  ...
                                  >
                                    ...
                                    <b-col cols="12" lg="1" class="mr-2">
                                      ...
                                      <validation-provider
                                        ...
                                        name="Measure"
                                        rules="required"
                                        ref="transectionMeasure"
                                      >
                                        <b-form-input
                                          id="transectionMeasure"
                  ...
                  <b-tab>
                    ...
                    <div v-if="companyInBG" class="d-flex">
                      ...
                      <div v-else class="flex-grow-1 ml-2">
                        <h6
                          style="color: #625f6e"
                          class="mb-1"
                          v-if="invoiceData.documentType == 'INVOICE'"
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <b-form-select
                                v-model="
                                  invoiceData.transactions[index].account
                                "
                                :options="accounts"
                              >
                              </b-form-select>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <b-form-select
                                        v-model="
                                          invoiceData.transactions[index]
                                            .account
                                        "
                                        :options="accounts"
                                      >
...
export default {
  ...
  computed: {
    formIsValid() {
      ...
      while (i < this.invoiceData.transactions.length) {
        ...
        if (
          this.invoiceData.xero &&
          this.companyData &&
          this.companyData.companyIsoAlpha2Country !== "BG"
        ) {
  ...
  setup() {
    ...
    const totalAmountInDecimal = computed({
      get() {
        return parseFloat(invoiceData.value.totalAmount || 0)?.toFixed(2);
      },
      set(newVal) {
        invoiceData.value.totalAmount = +newVal || 0;
      },
    });

    const totalSumInDecimal = computed({
      get() {
        return parseFloat(invoiceData.value.amountNonVat || 0)?.toFixed(2);
      },
      set(newVal) {
        invoiceData.value.amountNonVat = +newVal || 0;
      },
    });
    ...
    const totalTaxInDecimal = computed({
      get() {
        ...
        return parseFloat(invoiceData.value.vatAmount)?.toFixed(0);
      },
      set(newVal) {
