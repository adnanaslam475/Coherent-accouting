    ...
    <div class="m-2">
      ...
      <b-row>
        ...
        <b-col cols="12" md="8">
          <div class="d-flex">
            <b-col cols="2">
              <b-form-select v-model="documentType" :options="['INVOICE', 'RECEIPT']" />
            </b-col>
            <b-col cols="2">
              <b-form-select v-model="transactionType" :options="['INCOME', 'EXPANSE']" />
            </b-col>
            <b-col cols="2">
              <b-form-select v-model="lastDays" :options="lastDaysItems" />
            </b-col>
            <b-col cols="2">
    ...
    */
    ...
    async handleSearchSelect() {
      ...
      const data = await axios
        .post(`/account/api/invoice/search/${this.companyId}/1/${this.perPageRecords}`, data1, config)
        .then((res) => {
    ...
    async listInvoices() {
      ...
      this.companyId = router.currentRoute.params.id
      const data = await axios.get(`/account/api/invoice/list/${this.companyId}/${this.pageNum}/10`, config)
