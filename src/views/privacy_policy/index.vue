<template>
  <div class="allblue">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Coherent Accounting.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Coherent Accounting, accessible
          from
          <a
            href="https://coherent-accounting.com/"
    ...
    <ul>
      <li>By email: admin@coherent-accounting.com</li>
    </ul>
  </div>
</template>
