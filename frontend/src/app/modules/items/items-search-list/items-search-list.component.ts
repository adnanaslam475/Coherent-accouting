...
@Component({
  selector: 'app-items-search-list',
  templateUrl: './items-search-list.component.html',
  styleUrls: ['./items-search-list.component.scss']
})
export class ItemsSearchListComponent implements OnDestroy, OnInit {
