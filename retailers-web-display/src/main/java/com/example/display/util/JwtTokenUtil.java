...
public class JwtTokenUtil implements Serializable {
    ...
    public static LocalDateTime adaptToLocalDateTime (String string) {
//		https://stackoverflow.com/questions/21242110/convert-java-util-date-to-java-time-localdate
//		https://stackoverflow.com/questions/42763103/convert-string-yyyy-mm-dd-to-localdatetime
//		https://www.boraji.com/java-8-zoneddatetime-example
//		Date input = new Date(milis);
//		LocalDate date = input.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
    	LocalDate ld = LocalDate.parse(string, formatter);
		LocalDateTime date = ld.atStartOfDay();
		return date;
    }
